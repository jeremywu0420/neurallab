...
} from "@/components/ChapterProgress";
...
export default async function ChapterPage({
  ...
  return (
    <>
      <ReadingProgressBar />
      <ChapterKeyboardNav
        prevChapter={tutorial.prevChapter}
        nextChapter={tutorial.nextChapter}
      />
      <ChapterTracker chapterId={chapterId} />
      <ChapterTableOfContents sections={tutorial.sections} />
      ...
      <div className="page-transition max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 text-center text-xs text-[var(--foreground)]/30">
          使用 ← → 鍵切換章節
        </div>

        {/* Navigation */}
        <div className="flex items-center justify-between mt-8 pt-8 border-t border-[var(--border)]">
